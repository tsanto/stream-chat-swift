...
enum Configuration {
    ...
    enum DefaultValues {
        static let apiKey = "unqz94tn8ywf"
    ...
    struct TestUser {
        ...
        static var defaults: [Self] {
            [
                TestUser(
                    name: "Vojta Stavik",
                    id: "vojtastavik", // swiftlint:disable:next line_length
                ...
                TestUser(
                    name: "Vishal",
                    id: "vishal", // swiftlint:disable:next line_length
                    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoidmlzaGFsIn0.FshanP_U7ivSmBtsJu-kFmU75JEc5qOoceKmf0ikfgI"
                )
